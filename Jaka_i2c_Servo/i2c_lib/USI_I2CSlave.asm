;
; BP 16.4.11 Ported to CCS assembler from USI_I2CSlave.s43
; No problem with that, only directives are different see documents 
; SLAU157m.pdf, SLAU157q.pdf
;
;******************************************************************************
...
;BP            MODULE    TI_USI_I2C_SLAVE
;BP            RTMODEL   "__rt_version", "3"   ; Ensure correct runtime model
            ;Functions
;BP            PUBLIC    TI_USI_I2C_SlaveInit
;BP            PUBLIC    TI_SlavAdd
;BP            PUBLIC    TI_I2CState
;BP            PUBLIC    TI_RxFuncPtr
;BP            PUBLIC    TI_TxFuncPtr
;BP            PUBLIC    TI_StartFuncPtr

;BP            MODULE    TI_USI_I2C_SLAVE
;BP            RTMODEL   "__rt_version", "3"   ; Ensure correct runtime model
            ;Functions
               .def    TI_USI_I2C_SlaveInit
               .def    TI_SlavAdd
               .def    TI_I2CState
               .def    TI_RxFuncPtr
               .def    TI_TxFuncPtr
...
;TI_RxFuncPtr  DS      2
;TI_TxFuncPtr  DS      2
;TI_StartFuncPtr  DS   2            
      
;            RSEG    CODE                    ; Code is relocatable
;            EVEN
;#else
              
TI_SlavAdd        .usect ".bss",1
TI_LPMbit         .usect ".bss",1
                  .align 2 
TI_I2CState       .usect ".bss",2,2             
TI_RxFuncPtr      .usect ".bss",2,2
TI_TxFuncPtr      .usect ".bss",2,2
TI_StartFuncPtr   .usect ".bss",2,2            
...
;BP ;BP #ifdef USE_C_CONTEXT_SAVE 
            pop.w   R15
            pop.w   R14
            pop.w   R13
; BP ; BP #endif             
